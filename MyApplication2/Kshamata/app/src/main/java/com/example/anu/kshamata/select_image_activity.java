...
public class select_image_activity extends ActionBarActivity {
...
//                Intent i = new Intent(getBaseContext(), ImageText.class);
//                i.putExtra("EXTRA_SESSION_ID", e.getMessage());
//                startActivity(i);
            }
        }
    }
